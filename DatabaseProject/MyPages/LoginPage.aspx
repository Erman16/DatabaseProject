<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoginPage.aspx.cs" Inherits="DatabaseProject.MyPages.LoginPage" %>
    ...
    <main class="form-signin w-100 m-auto">
        <form id="loginForm" runat="server">
            ...
            <div class="form-floating">
                <input class="form-control" id="email" placeholder=" " runat="server"/>
                <label for="company">Email</label>
                <asp:RequiredFieldValidator ID="usernameValidator" runat="server" ErrorMessage="Required" ForeColor="Red" ControlToValidate="email"></asp:RequiredFieldValidator>
            </div>
            <div class="form-floating">
